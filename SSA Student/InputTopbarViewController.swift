//
//  InputTopbarViewController.swift
//  Alpha
//
//  Created by pro admin on 9/10/17.
...
class InputTopbarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.child = (stb.instantiateViewController(withIdentifier: "in") as! InputTableViewController)
