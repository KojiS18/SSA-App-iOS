...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    override init() {
        ...
        schoolDaysInfo = [[0, 8, 29, 17, 2, 1, 1],
                          [1, 8, 30, 17, 3, 1, 2],
                          [2, 8, 31, 17, 4, 2, 0],
                          [3, 9, 1, 17, 5, 3, 0],
                          [4, 9, 4, 17, 1, 4, 0],
    ...
    func viewControllerAtIndex(_ index: Int, storyboard: UIStoryboard) -> DataViewController? {
        ...
        dataViewController.completedate = "\(intToDay[self.schoolDaysInfo[index][4]] ?? "error"), Day \(self.schoolDaysInfo[index][5]), \(self.schoolDaysInfo[index][1])/\(self.schoolDaysInfo[index][2])/\(self.schoolDaysInfo[index][3])"
